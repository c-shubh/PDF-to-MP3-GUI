...
class Widgets:
    def __init__(self, tabFrame):
        ...
        self.leftFrame = ttk.Frame(
            tabFrame, borderwidth=1, relief="groove")
        ...
        self.selectedFileDisplayLabel = ttk.Label(
            self.leftFrame, textvariable=self.selectedFileDisplayVar, style="all.TLabel", wraplength=500)

        self.separatorAfterSelectedFileDisplayLabel = ttk.Separator(
            self.leftFrame)
        ...
        self.maleRadioButton = ttk.Radiobutton(self.leftFrame, text="Male",
                                               variable=self.maleFemaleRadioButtonVar, value=Constants.MALE_VOICE, style="all.TRadiobutton")
        self.femaleRadioButton = ttk.Radiobutton(self.leftFrame, text="Female",
                                                 variable=self.maleFemaleRadioButtonVar, value=Constants.FEMALE_VOICE, style="all.TRadiobutton")
        ...
        self.normalRadioButton = ttk.Radiobutton(self.leftFrame, text="Normal",
                                                 variable=self.normalSlowFastRadioButtonVar, value=Constants.NORMAL_SPEED, style="all.TRadiobutton")
        self.slowRadioButton = ttk.Radiobutton(self.leftFrame, text="Slow",
                                               variable=self.normalSlowFastRadioButtonVar, value=Constants.SLOW_SPEED, style="all.TRadiobutton")
        self.fastRadioButton = ttk.Radiobutton(self.leftFrame, text="Fast",
                                               variable=self.normalSlowFastRadioButtonVar, value=Constants.FAST_SPEED, style="all.TRadiobutton")

        self.separatorAfterFastRadioButton = ttk.Separator(self.leftFrame)

        self.saveMp3Button = ttk.Button(self.leftFrame, text="Save MP3",
                                        style="all.TButton", state="disabled")
